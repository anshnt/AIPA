...
def parse_arguments() -> Namespace:
    ...
    Available arguments:
        ...
        --import-v0: Import data from a v0 (aipa) database with the given path
    ...
    parser.add_argument(
        "--import-v0",
        help="Import data from a v0 (aipa) database with the given path",
        required=False,
    )
...
def load_config(args: Namespace) -> Optional[Config]:
    """
    Load Aipa JSON configuration file and apply command-line arguments.
