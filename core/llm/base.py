        ...
        *,
        ...
        while True:
            if remaining_retries == 0:
                ...
                # They don't want to retry (or we can't ask them), raise the last error and stop Aipa
            ...
            try:
                ...
                # Token limit exceeded (in original aipa handled as
                ...
                if err_code in ("request_too_large", "context_length_exceeded", "string_above_max_length"):
                    ...
                    message = "".join(
                        [
                            ...
                            "Here's how you can get AIPA to ignore those extra files: ",
