...
class Telemetry:
    """
    Aipa telemetry data collection.
    ...
    def clear_data(self):
        ...
        self.data = {
            ...
            # Python version used for AIPA
            "python_version": sys.version,
            # AIPA version
            "pilot_version": get_version(),
            # Aipa VSCode Extension version
        ...
        self.data.update(
            {
                ...
                "elapsed_time": 0,
                # Total number of lines created by AIPA
                "created_lines": 0,
                ...
                "user_feedback": None,
                # If AIPA crashes, record diagnostics
