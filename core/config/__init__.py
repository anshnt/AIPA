...
EXTERNAL_DOCUMENTATION_API = "http://docs-Aipa-io-439719575.us-east-1.elb.amazonaws.com"
...
class AgentLLMConfig(_StrictModel):
    """
    Configuration for the various LLMs used by Aipa.
