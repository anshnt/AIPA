...
INITIAL_PROJECT_HOWTO_URL = (
    "https://github.com/Aipa-io/aipa/wiki/How-to-write-a-good-initial-project-description"
)
...
class SpecWriter(BaseAgent):
    ...
    async def analyze_spec(self, spec: str) -> str:
        msg = (
            ...
            "The better you can describe the project, the better AIPA will understand what you'd like to build.\n\n"
